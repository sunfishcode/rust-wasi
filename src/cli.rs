    ...
    pub fn read(
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_read")]
    ...
    pub fn skip(this: InputStream, len: u64) -> Result<(u64, bool), StreamError> {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_skip")]
                fn wit_import(_: i32, _: i64, _: i32);
            }
            wit_import(
                wit_bindgen::rt::as_i32(this),
    ...
    pub fn subscribe_to_input_stream(this: InputStream) -> Pollable {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(
                    not(target_arch = "wasm32"),
                    link_name = "io_subscribe-to-input-stream"
                )]
    ...
    pub fn drop_input_stream(this: InputStream) {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_drop-input-stream")]
                fn wit_import(_: i32);
            }
            wit_import(wit_bindgen::rt::as_i32(this));
        }
    ...
    pub fn write(this: OutputStream, buf: &[u8]) -> Result<u64, StreamError> {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_write")]
    ...
    pub fn write_zeroes(this: OutputStream, len: u64) -> Result<u64, StreamError> {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_write-zeroes")]
                fn wit_import(_: i32, _: i64, _: i32);
            }
            wit_import(
                wit_bindgen::rt::as_i32(this),
    ...
    pub fn splice(
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_splice")]
    ...
    pub fn forward(this: OutputStream, src: InputStream) -> Result<u64, StreamError> {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_forward")]
                fn wit_import(_: i32, _: i32, _: i32);
            }
            wit_import(
                wit_bindgen::rt::as_i32(this),
    ...
    pub fn subscribe_to_output_stream(this: OutputStream) -> Pollable {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(
                    not(target_arch = "wasm32"),
                    link_name = "io_subscribe-to-output-stream"
                )]
                fn wit_import(_: i32) -> i32;
            }
            let ret = wit_import(wit_bindgen::rt::as_i32(this));
    ...
    pub fn drop_output_stream(this: OutputStream) {
        ...
        unsafe {
            ...
            extern "C" {
                ...
                #[cfg_attr(not(target_arch = "wasm32"), link_name = "io_drop-output-stream")]
                fn wit_import(_: i32);
            }
            wit_import(wit_bindgen::rt::as_i32(this));
        }
...
#[allow(clippy::all)]
pub mod filesystem {
    pub type InputStream = super::io::InputStream;
    pub type OutputStream = super::io::OutputStream;
    pub type Datetime = super::wall_clock::Datetime;
...
pub type InputStream = io::InputStream;
pub type OutputStream = io::OutputStream;
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 8254] = [
    ...
    120, 105, 116, 9, 112, 107, 103, 58, 47, 101, 120, 105, 116, 3, 0, 0, 7, 234, 62, 1, 65, 2, 1,
    65, 57, 1, 66, 9, 1, 121, 4, 10, 119, 97, 108, 108, 45, 99, 108, 111, 99, 107, 0, 3, 0, 0, 1,
    ...
    111, 112, 45, 111, 117, 116, 112, 117, 116, 45, 115, 116, 114, 101, 97, 109, 0, 1, 23, 3, 2,
    105, 111, 24, 112, 97, 116, 104, 58, 47, 105, 111, 47, 115, 116, 114, 101, 97, 109, 115, 47,
    115, 116, 114, 101, 97, 109, 115, 5, 10, 2, 3, 0, 6, 12, 105, 110, 112, 117, 116, 45, 115, 116,
    114, 101, 97, 109, 2, 3, 0, 6, 13, 111, 117, 116, 112, 117, 116, 45, 115, 116, 114, 101, 97,
    109, 1, 66, 115, 2, 3, 2, 1, 11, 4, 12, 105, 110, 112, 117, 116, 45, 115, 116, 114, 101, 97,
    109, 0, 3, 0, 0, 2, 3, 2, 1, 12, 4, 13, 111, 117, 116, 112, 117, 116, 45, 115, 
    115, 105, 111, 110, 115, 45, 97, 116, 0, 1, 74, 4, 11, 108, 111, 99, 107, 45, 115, 104, 97,
    114, 101, 100, 0, 1, 46, 4, 14, 108, 111, 99, 107, 45, 101, 120, 99, 108, 117, 115, 105, 118,
    101, 0, 1, 46, 4, 15, 116, 114, 121, 45, 108, 111, 99, 107, 45, 115, 104, 97, 114, 101, 100, 0,
    1, 46, 4, 18, 116, 114, 121, 45, 108, 111, 99, 107, 45, 101, 120, 99, 108, 117, 115, 105, 118,
    101, 0, 1, 46, 4, 6, 117, 110, 108, 111, 99, 107, 0, 1, 46, 1, 64, 1, 4, 116, 104, 105, 115,
    32, 1, 0, 4, 15, 100, 114, 111, 112, 45, 100, 101, 115, 99, 114, 105, 112, 116, 111, 114, 0, 1,
    75, 1, 107, 28, 1, 106, 1, 204, 0, 1, 19, 1, 64, 1, 4, 116, 104, 105, 115, 21, 0, 205, 0, 4,
    20, 114, 101, 97, 100, 45, 100, 105, 114, 101, 99, 116, 111, 114, 121, 45, 101, 110, 116, 114,
    121, 0, 1, 78, 1, 64, 1, 4, 116, 104, 105, 115, 21, 1, 0, 4, 27, 100, 114, 111, 112, 45, 100,
    105, 114, 101, 99, 116, 111, 114, 121, 45, 101, 110, 116, 114, 121, 45, 115, 116, 114, 101, 97,
    109, 0, 1, 79, 3, 10, 102, 105, 108, 101, 115, 121, 115, 116, 101, 109, 38, 112, 97, 116, 104,
    ...
    5, 28, 1, 66, 3, 1, 106, 0, 0, 1, 64, 1, 6, 115, 116, 97, 116, 117, 115, 0, 1, 0, 4, 4, 101,
    120, 105, 116, 0, 1, 1, 3, 4, 101, 120, 105, 116, 19, 112, 107, 103, 58, 47, 101, 120, 105,
    116, 47, 119, 97, 115, 105, 45, 101, 120, 105, 116, 5, 29, 3, 12, 105, 110, 112, 117, 116, 45,
    115, 116, 114, 101, 97, 109, 0, 3, 0, 11, 3, 13, 111, 117, 116, 112, 117, 116, 45, 115, 116,
    114, 101, 97, 109, 0, 3, 0, 12, 2, 3, 0, 7, 10, 100, 101, 115, 99, 114, 105, 112, 116, 111,
    114, 3, 10, 100, 101, 115, 99, 114, 105, 112, 116, 111, 114, 0, 3, 0, 32, 1, 112, 115, 1, 111,
    2, 33, 115, 1, 112, 35, 1, 106, 0, 0, 1, 64, 5, 5, 115, 116, 100, 105, 110, 30, 6, 115, 116,
    100, 111, 117, 116, 31, 6, 115, 116, 100, 101, 114, 114, 31, 4, 97, 114, 103, 115, 34, 8, 112,
    114, 101, 111, 112, 101, 110, 115, 36, 0, 37, 4, 7, 99, 111, 109, 109, 97, 110, 100, 0, 1, 38,
    4, 3, 99, 108, 105, 12, 112, 107, 103, 58, 47, 99, 108, 105, 47, 99, 108, 105, 4, 0, 0, 78, 9,
    ...
    55, 46, 49, 26, 119, 105, 116, 45, 98, 105, 110, 100, 103, 101, 110, 45, 103, 101, 110, 45,
    103, 117, 101, 115, 116, 45, 114, 117, 115, 116, 5, 48, 46, 51, 46, 48, 11, 17, 1, 3, 99, 108,
    105, 8, 112, 107, 103, 58, 47, 99, 108, 105, 3, 2, 0,
];
